...
!! QQ
!if (icell .eqv. 5) then
!  write(*,*) 'ISC SOM1 + TOSOM2NET: ', ilayer, Rng(icell)%intermediate_soil_carbon, tosom2net
!end if
!! QQ
...
!! QQ
!if (icell .eqv. 5) then
!  write(*,*) 'ISC DCMP - TCDEC    : ', ilayer, Rng(icell)%intermediate_soil_carbon, tcdec
!end if
!! QQ
...
!****
!**** R. Boone   Last modified: January 26, 2011
  use Parameter_Vars
  use Structures
  implicit none
...
!! QQ
!if (icell .eqv. 5) then
!  write(*,*) 'ISC LIGN + TOSOM2NET: ', ilayer, Rng(icell)%intermediate_soil_carbon, tosom2net
!end if
!! QQ
    Rng(icell)%intermediate_soil_carbon = Rng(icell)%intermediate_soil_carbon + tosom2net
    woodc = woodc - tcdec
