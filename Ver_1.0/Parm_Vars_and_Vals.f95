module Parameter_Vars
  ! The Parameter_Vars module stores parameters used in the G-Range model, and constants that are needed.  Modified Aug 25, 2018

  ! Constants
  integer, parameter  :: MAX_X_DIM=1440, MAX_Y_DIM=720              ! MAX_X_DIM=720, MAX_Y_DIM=360               ! MAX_X_DIM=3600, MAX_Y_DIM=1800
  integer, parameter  :: MAX_RANGE_CELLS=80000                      ! MAX_RANGE_CELLS=60000   ! MAX_RANGE_CELLS=1200000
  character(12)       :: INI_FILE='\L_Range.ini'                    ! The one-line init file in the program directory, pointing to the application directory.
