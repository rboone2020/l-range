...
!**** R. Boone    Last modified: August 8, 2017
   ...
   write(*,*)
   write(*,*) '     L-RANGE Ver 1.0  February 10, 2024 '
   write(*,*)
   ! ***************************************************
   ! ***************************************************
   ...
   if (ioerr == 0) then
     ...
     write(*,*) 'The application path cannot be read from the L_RANGE.INI file in the program directory: ', &
...
1002  format(5000I1)                                  ! This value is hardwired.
   ...
   !************************************************************************
   !NOTE: This section is a relic of G-Range, but Rng is central to the model
   !      and invisible to the user.  I will retain the structure.
   !      I am removing the part with the legend that indicates rangelands,
   !      however.  At the scale of a study site, non-rangelands can be set
   !      to zeros in the LAND COVER map to not be simulated.
   !************************************************************************
...
!*****
!***** R. Boone    Last modified: Oct 10, 2014.  Dead matter set to 0, rather than live stocks.
!*****                                            Removed error in dividing bulk density by 100, and organic matter also.
!*****                                           Modified to remove subtraction of shrub facet from herb/shrub layer.   Now those layers are modified directly to represent the given facets.
   use Parameter_Vars
   use Structures
   implicit none
