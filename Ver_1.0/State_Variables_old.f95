...
!****
!**** R. Boone   Last modified: December 28, 2013.  Altered to include the latest changes to the state variables.
   use Parameter_Vars
   use Structures
   implicit none
   ...
   integer  zonetemp
   real     cellsizetemp
   write(*,*) app_path(1:len_trim(app_path))//Sim_Parm%state_var_file_in
